        ...
        <>
            ...
            <section className="py-16">
                <div className="container px-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-4 p-6 md:p-8 min-h-112.5 bg-(--yellow) text-(--background)">
                    ...
                    <div className="flex flex-col items-center gap-4 p-6 md:p-8 min-h-112.5 bg-(--yellow) text-(--background)">
            ...
            <section className="py-4">
                <div className="container px-4 grid gap-16 text-center text-sm md:text-base grid-cols-1 md:grid-cols-4 border-y py-12">
